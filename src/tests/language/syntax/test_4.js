angular.module('llt.app')
    .constant('LANGUAGE_SYNTAX_4', [
      {
        question: 'Визначте тип словосполучення за способом вираження головного слова.<em>Далеко від дому, трохи жарко, мокро від дощу<em>',
        answers: [
          {
            text: 'іменникове'
          },
      ...
      {
        question: 'Яким членом речення є виділене слово?<em><strong>Визволені</strong> не можуть забути своїх визволителів (О. Гончар).<em>',
        answers: [
          {
            text: 'підметом',
            correct: true
      ...
      {
        question: 'Визначте, чим ускладнене просте речення.<em>І сміх і гріх було дивитися на цю недоладну постать, натоптану злобою і болем (М. Стельмах).<em>',
        answers: [
          {
      ...
      {
        question: 'З’ясуйте умови відокремлення означення.<em>Оповитий рожевим туманом, далекий острів немов зрушив з місця і поплив у морі мінливого сяйва (О. Донченко).<em>',
        answers: [
          {
      ...
      {
        question: 'Яким є подане речення?<em>Підтягнувши щит ближче до світла, Ігор провів по ньому рукою (Ю. Щербак).<em>',
        answers: [
          {
      ...
      {
        question: 'Яким членом речення є виділене слово?<em>Пане Попель, <strong>розмовляти</strong> з вами – велика приємність (Ю. Андрухович).<em>',
        answers: [
          {
            text: 'підметом',
            correct: true
