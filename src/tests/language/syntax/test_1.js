angular.module('llt.app')
  .constant('LANGUAGE_SYNTAX_1', [
    {
      question: 'Визначте тип словосполучення за способом вираження головного слова.<em>Зустрів її, пішли зі мною, прочитаю газет<em>',
      answers: [
        {
          text: 'іменникове'
        },
    ...
    {
      question: 'Яким членом речення є виділене слово?<em>Електричний ліхтар <strong>на березі</strong> змагався з темрявою, яка, здавалося, суцільним муром насувалася з моря (О. Донченко).<em>',
      answers: [
        {
          text: 'підметом'
        },
    ...
    {
      question: 'Визначте, чим ускладнене просте речення.<em>Там, на столі, лежить моє перо (Л. Костенко).<em>',
      answers: [
        {
    ...
    {
      question: 'З’ясуйте умови відокремлення означення.<em>Пахло васильками, натиканими за сволок, і татарським зіллям, розкиданим на чисто вимитій підлозі (П. Панч).<em>',
      answers: [
        {
    ...
    {
      question: 'Яким є подане речення?<em>Сірий, припорошений весняною пилюкою степ збігає на південь і стигне там голубим маревом (Г. Тютюнник).<em>',
      answers: [
        {
    ...
    {
      question: 'Яким членом речення є виділене слово?<em>Я скликав раду в суботу не <strong>в таборі</strong>, не в гетьманському наметі, а на пасіці (П. Загребельний)<em>',
      answers: [
        {
          text: 'підметом'
        },
