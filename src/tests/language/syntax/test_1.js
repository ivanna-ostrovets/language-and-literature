angular.module('llt.app')
  .constant('LANGUAGE_SYNTAX_1', [
    {
      question: 'Визначте тип словосполучення за способом вираження головного слова.<br/><em>Зустрів її, пішли зі мною, прочитаю газет</em>',
      answers: [
        {
          text: 'іменникове'
        },
    ...
    {
      question: 'Яким членом речення є виділене слово?<br/><em>Електричний ліхтар <strong>на березі</strong> змагався з темрявою, яка, здавалося, суцільним муром насувалася з моря (О. Донченко).<br/><em>',
      answers: [
        {
          text: 'підметом'
        },
    ...
    {
      question: 'Визначте, чим ускладнене просте речення.<br/><em>Там, на столі, лежить моє перо (Л. Костенко).<br/><em>',
      answers: [
        {
    ...
    {
      question: 'З’ясуйте умови відокремлення означення.<br/><em>Пахло васильками, натиканими за сволок, і татарським зіллям, розкиданим на чисто вимитій підлозі (П. Панч).<br/><em>',
      answers: [
        {
    ...
    {
      question: 'Яким є подане речення?<br/><em>Сірий, припорошений весняною пилюкою степ збігає на південь і стигне там голубим маревом (Г. Тютюнник).<br/><em>',
      answers: [
        {
    ...
    {
      question: 'Яким членом речення є виділене слово?<br/><em>Я скликав раду в суботу не <strong>в таборі</strong>, не в гетьманському наметі, а на пасіці (П. Загребельний)<br/><em>',
      answers: [
        {
          text: 'підметом'
        },
