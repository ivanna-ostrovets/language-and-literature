angular.module('llt.app')
    .constant('LANGUAGE_SYNTAX_3', [
      {
        question: 'Визначте тип словосполучення за способом вираження головного слова.<br/><em>Мокрий від дощу, дуже холодний, слизький від льоду<br/><em>',
        answers: [
          {
            text: 'іменникове'
          },
      ...
      {
        question: 'Яким членом речення є виділене слово?<br/><em>Приємно бродити по теплих калюжах після грому й дощу, чи ловити щучок руками, скаламутивши воду, або дивитись, як тягнуть <strong>волок</strong> (О. Донченко).<br/><em>',
        answers: [
          {
            text: 'підметом'
          },
      ...
      {
        question: 'Визначте, чим ускладнене просте речення.<br/><em>Серед степу, серед налитої зеленим хлібом долини, течуть тепер мої дні (М. Коцюбинський).<br/><em>',
        answers: [
          {
      ...
      {
        question: 'З’ясуйте умови відокремлення означення.<br/><em>Акації стояли саме в цвіту, заквітчані безліччю білих китиць (І. Нечуй-Левицький).<br/><em>',
        answers: [
          {
      ...
      {
        question: 'Яким є подане речення?<br/><em>Щоб не пломеніти горобині самотньо, посадив я поблизу нашу українську калину (І. Цюпа).<br/><em>',
        answers: [
          {
      ...
      {
        question: 'Яким членом речення є виділене слово?<br/><em>Бути людиною – <strong>дертись</strong> по вертикальній стіні. Сизифова робота (В. Стус).<br/><em>',
        answers: [
          {
            text: 'підметом'
          },
