angular.module('llt.app')
    .constant('LANGUAGE_SYNTAX_3', [
      {
        question: 'Визначте тип словосполучення за способом вираження головного слова.<br/><br/><em>Мокрий від дощу, дуже холодний, слизький від льоду</em>',
        answers: [
          {
            text: 'іменникове'
          },
      ...
      {
        question: 'Яким членом речення є виділене слово?<br/><br/><em>Приємно бродити по теплих калюжах після грому й дощу, чи ловити щучок руками, скаламутивши воду, або дивитись, як тягнуть <strong>волок</strong> (О. Донченко).</em>',
        answers: [
          {
            text: 'підметом'
          },
      ...
      {
        question: 'Визначте, чим ускладнене просте речення.<br/><br/><em>Серед степу, серед налитої зеленим хлібом долини, течуть тепер мої дні (М. Коцюбинський).</em>',
        answers: [
          {
      ...
      {
        question: 'З’ясуйте умови відокремлення означення.<br/><br/><em>Акації стояли саме в цвіту, заквітчані безліччю білих китиць (І. Нечуй-Левицький).</em>',
        answers: [
          {
      ...
      {
        question: 'Яким є подане речення?<br/><br/><em>Щоб не пломеніти горобині самотньо, посадив я поблизу нашу українську калину (І. Цюпа).</em>',
        answers: [
          {
      ...
      {
        question: 'Яким членом речення є виділене слово?<br/><br/><em>Бути людиною – <strong>дертись</strong> по вертикальній стіні. Сизифова робота (В. Стус).</em>',
        answers: [
          {
            text: 'підметом'
          },
