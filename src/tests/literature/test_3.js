angular.module('llt.app')
    .constant('LITERATURE_3', [
      ...
      {
        question: 'Рядки <em><br/>Ніч у сніговій завії<br/>крутиться довкола стріх.<br/>У долоні у Марії<br/>місяць – золотий горіх<br/><em> написав',
        answers: [
          {
      ...
      {
        question: 'Рядки <em><br/>Йде весна<br/>Запашна,<br/>Квітами-перлами<br/>Закосичена<br/><em> узяті з твору',
        answers: [
          {
