angular.module('llt.app')
    .constant('LITERATURE_3', [
      ...
      {
        question: '<br/><em>"Ні! Я жива! Я буду вічно жити! Я в серці маю те, що не вмирає!"<br/><em> – слова',
        answers: [
          {
      ...
      {
        question: '<br/><em>"Шумить, гуде Тополівка. До Лавріна Запорожця приїхали гості"<br/><em> – так починається оповідь про події твору',
        answers: [
          {
      ...
      {
        question: 'Рядки <br/><em><br/>Ніч у сніговій завії<br/>крутиться довкола стріх.<br/>У долоні у Марії<br/>місяць – золотий горіх<br/><br/><em> написав',
        answers: [
          {
      ...
      {
        question: 'Рядки <br/><em><br/>Йде весна<br/>Запашна,<br/>Квітами-перлами<br/>Закосичена<br/><br/><em> узяті з твору',
        answers: [
          {
